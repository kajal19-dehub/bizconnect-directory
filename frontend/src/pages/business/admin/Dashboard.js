...
const AdminDashboard = () => {
  ...
  const handleVerification = (businessId, action) => {
    // API call to verify/reject business
    console.log(`${action} business ${businessId}`);
  };

  const handleIssueAction = (issueId, action) => {
    // API call to handle reported issue
                ...
                <div key={business.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                  ...
                  <div className="flex items-center space-x-2">
                    {business.status === 'pending' ? (
                      <>
                        <button
                          onClick={() => handleVerification(business.id, 'verify')}
                        ...
                        <button
                          onClick={() => handleVerification(business.id, 'reject')}
                  ...
                  <tr key={issue.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-4">
                      <div className="flex space-x-2">
                        <button
                          onClick={() => handleIssueAction(issue.id, 'view')}
